...
class HelloViewSet(viewsets.ViewSet):
    """Simple viewset to demonstrate how viewsets work"""
    serializer_class = serializers.HelloSerializer
...
# Handles all the create, list and ... functionalities automatically
...
class UserLoginAPIView(ObtainAuthToken):
    ...
    # Makes the login form visible when we are testing the API.
